...
const STAPLES = [
  ...
  { keywords: ["milk", "whole milk", "full fat milk"], name: "Milk, whole", serving: "100 ml", grams: 100, cal: 61, p: 3.2, c: 4.8, f: 3.3 },
  { keywords: ["semi-skimmed milk", "semi skimmed milk", "reduced fat milk", "2% milk"], name: "Milk, semi-skimmed", serving: "100 ml", grams: 100, cal: 46, p: 3.4, c: 4.8, f: 1.7 },
  { keywords: ["skimmed milk", "skim milk", "fat free milk", "nonfat milk"], name: "Milk, skimmed", serving: "100 ml", grams: 100, cal: 35, p: 3.4, c: 5, f: 0.1 },
